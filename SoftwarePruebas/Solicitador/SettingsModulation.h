...
#define MULTITECH_ISM2400_BANDWITH        LORA_BW_1600
#define MULTITECH_ISM2400_SF              LORA_SF10
#define MULTITECH_ISM2400_CR              LORA_CR_LI_4_5
...
const uint16_t packet_delay = 10;             //mS delay between packets
